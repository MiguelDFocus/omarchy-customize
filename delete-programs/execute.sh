...
bash $OMARCHY_CUSTOMIZE_ROOT/delete-programs/uninstall-pinta.sh
bash $OMARCHY_CUSTOMIZE_ROOT/delete-programs/uninstall-print-settings.sh
bash $OMARCHY_CUSTOMIZE_ROOT/delete-programs/uninstall-signal.sh
bash $OMARCHY_CUSTOMIZE_ROOT/delete-programs/uninstall-typora.sh
bash $OMARCHY_CUSTOMIZE_ROOT/delete-programs/uninstall-xournal.sh
